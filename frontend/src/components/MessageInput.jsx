...
export default function MessageInput({ onSend, disabled, onStop, isStreaming }) {
    ...
    <footer className="p-4 bg-gradient-to-t from-gray-900 via-gray-900 to-transparent">
      <div className="max-w-4xl mx-auto flex gap-3">
        <input
          ...
          disabled={disabled}
          placeholder={isStreaming ? 'AI 正在回复中...' : '输入你的问题或任务...'}
          autoComplete="off"
        ...
        {isStreaming ? (
          <button
            onClick={onStop}
            className="bg-red-600 hover:bg-red-500 text-white px-6 py-4 rounded-xl font-bold text-sm tracking-wider transition-all active:scale-95 flex items-center shadow-lg shadow-red-600/20"
          >
            ⏹ 停止
          </button>
        ) : (
